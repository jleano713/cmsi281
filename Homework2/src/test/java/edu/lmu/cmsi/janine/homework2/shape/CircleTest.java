...
public class CircleTest {
	...
	@Test
	public void getCirfumferenceTest() {
		Point point1 = new Point(3.0, 3.2);
		Circle circle = new Circle(point1, 3.0);
		double circumference = 2 * 3.0 * Math.PI;
		assertEquals("failure - circumference didn't match", circle.getRadius() * Math.PI * 2, circumference, circle.getCircumference());
	}
